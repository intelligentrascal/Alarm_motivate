...
[![GitHub Release](https://img.shields.io/github/v/release/intelligentrascal/Ha-sketch)](https://github.com/intelligentrascal/Ha-sketch/releases)
...
3. Add `https://github.com/intelligentrascal/Ha-sketch` and select **Lovelace** category
4. Click **Install**
5. Refresh your browser

### Manual

1. Download `ha-sketchbook-cards.js` from the [latest release](https://github.com/intelligentrascal/Ha-sketch/releases/latest)
